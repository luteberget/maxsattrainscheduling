...
data["author","likes","paper"].edge_index = data["author","writes","paper"].edge_index
data["author","likes","paper"].edge_attr = data["author","writes","paper"].edge_attr
...
print(summary(model, data.x_dict, data.edge_index_dict, data.edge_attr_dict,max_depth=99,leaf_module=None))
